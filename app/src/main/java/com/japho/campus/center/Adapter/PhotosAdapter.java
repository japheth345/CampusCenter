...
public class PhotosAdapter extends RecyclerView.Adapter<PhotosAdapter.Viewholder> {
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.photos_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull final Viewholder holder, int position) {
        ...
        holder.like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (holder.like.getTag().equals("like")) {
                    ...
                    addNotification(post.getPostid(),post.getPublisher(),"Liked your Photo  post","photo");
                } else {
                    FirebaseDatabase.getInstance().getReference().child("Likes")
        ...
        holder.postImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((FragmentActivity)mContext).getSupportFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container, new PhotoPostDetailFragment()).commit();
            }
        });
