...
public class TextsAdapter extends RecyclerView.Adapter<TextsAdapter.Viewholder> {
    ...
    public TextsAdapter(Context mContext, List<Post> mPosts) {
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.texts_layout, parent, false);
        return new TextsAdapter.Viewholder(view);
    }
        ...
        holder.like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (holder.like.getTag().equals("like")) {
                    ...
                    addNotification(post.getPostid(),post.getPublisher(),"Liked your Text post","text");
                } else {
                    FirebaseDatabase.getInstance().getReference().child("Likes")
        ...
        */
        ...
        holder.description.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((FragmentActivity)mContext).getSupportFragmentManager().beginTransaction()
                        .replace(R.id.fragment_container, new TextPostDetailFragment()).commit();
            }
        });
